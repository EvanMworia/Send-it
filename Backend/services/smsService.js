...
export async function sendSMSToRecepient(parcelSender, parcelReceipientPhone, pickupLocation) {
	// TODO: Send message
	try {
		const result = await africastalking.SMS.send({
			// to: process.env.AT_RECEIVER,
			...
			message: `Parcel Comming your way.
				${parcelSender} has sent you a parcel, the pickup point is ${pickupLocation}. We will notify you once your parcel arrives
